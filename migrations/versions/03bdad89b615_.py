...
Revision ID: 03bdad89b615
Revises: 
Create Date: 2023-02-16 12:38:42.549035
...
def upgrade():
    ...
    sa.Column('status_shooping', sa.Enum('active', 'inactive', 'reserved', name='status_shooping_enum_2'), nullable=False),
    ...
    sa.Column('status_shopping', sa.Enum('active', 'inactive', 'completed', name='status_shopping_enum_3'), nullable=False),
    sa.Column('created_at_shopping', sa.DateTime(), nullable=False),
    sa.Column('updated_at_shopping', sa.DateTime(), nullable=False),
    sa.Column('price', sa.Numeric(), nullable=False),
    sa.Column('status_paid', sa.Enum('paid', 'pending', 'refunded', name='status_paid_enum_2'), nullable=False),
