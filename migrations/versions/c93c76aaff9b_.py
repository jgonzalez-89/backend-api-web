...
Revision ID: c93c76aaff9b
Revises: 
Create Date: 2023-02-14 15:09:18.862663
...
def upgrade():
    ...
    sa.Column('dob_age', sa.Integer(), nullable=False),
    ...
    sa.Column('status_shooping', sa.Enum('active', 'inactive', 'reserved', name='status_shooping__'), nullable=False),
    ...
    sa.Column('status_shopping', sa.Enum('active', 'inactive', 'completed', name='__status_shopping_enum'), nullable=False),
    sa.Column('created_at_shopping', sa.DateTime(), nullable=False),
    sa.Column('updated_at_shopping', sa.DateTime(), nullable=False),
    sa.Column('price', sa.Numeric(), nullable=False),
    sa.Column('status_paid', sa.Enum('paid', 'pending', 'refunded', name='__status_paid_enum'), nullable=False),
