...
class Product(db.Model):
    ...
    status_shooping = db.Column(
        db.Enum("active", "inactive", "reserved", name="status_shooping_enum_2")
    )
...
class ShoppingProduct(db.Model):
    ...
    status_shopping = db.Column(
        db.Enum("active", "inactive", "completed", name="status_shopping_enum_3"),
        nullable=False,
    )
    ...
    status_paid = db.Column(
        db.Enum("paid", "pending", "refunded", name="status_paid_enum_2"),
        nullable=False,
    )
